      ...
      const formattedProduct = {
        ...
        variants: product.variants.edges.map((variant) => {
          ...
          return {
            ...
            availableQuantity: variant.node.quantityAvailable || 100,
            size: size ?? null,
  ...
  cartParser(cart) {
    ...
    const optionParser = (input) => {
      return {
        ...
        availableQuantity: input.quantityAvailable || 100,
      }
    }
    ...
    try {
      ...
      const collectionData = {
        ...
        image: collectionByHandle.image
          ? {
              src: collectionByHandle.image.originalSrc || '',
              alt:
                collectionByHandle.image.altText ||
                collectionByHandle.title ||
                '',
            }
          : null,
      }
